...
```{r}
getwd()
setwd("/Users/sophiep/Desktop/Group5/")


files <- list.files(path = '/Users/sophiep/Desktop/Group5/5/', pattern='csv', full.names = TRUE)
...
#(sub_dat$gene_symbol, fromLast = TRUE)|duplicated(sub_dat$mouse_life_stage, fromLast = TRUE)| duplicated(sub_dat$mouse_strain, fromLast = TRUE)]
